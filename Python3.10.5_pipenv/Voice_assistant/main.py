...
def record_and_recognize_audio(*args: tuple):
    ...
    with microphone:
        ...
        try:
            ...
            print("[+] Проверьте, включен-ли ваш микрофон, пожалуйста?")
            return

        # использование online-распознавания через Google 
        try:
            print("[+] Начато распознавание...")
        ...
        # использовать offline-распознавание через Vosk
            ...
            print("[+] Пробую распознать без интернет соединения...")
...
def use_offline_recognition():
    ...
    try:
        ...
        if not os.path.exists("models/vosk-model-small-ru-0.4"):
            print("[+] Пожалуйста, загрузите модель с:\n"
        ...
        offline_recognizer = KaldiRecognizer(model,
        ...
        print("К сожалению, голосовой сервис недоступен. Попробуйте позже")
