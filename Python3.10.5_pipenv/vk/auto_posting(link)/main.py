#!/usr/bin/python3
#
# Авто постинг картинок в группу вк. Картинка скачивается по ссылке из файла, использованная ссылка удаляется.
# Картинка сначала загружается на сервер вк, по ней выдается айди, по айди делаем пост.
